...
//         setTimeout(() => {
//             alert(`🎉 Order Placed Successfully! Total amount of ₹${finalToPay.toFixed(2)} is confirmed.`);
//             dispatch(clearCart());
...
//                                 className="w-full h-12 bg-gradient-to-r from-amber-500 to-orange-500 text-black font-mono font-bold text-xs uppercase tracking-widest rounded-xl disabled:opacity-50 shadow-md hover:shadow-lg transition-all active:scale-[0.99] cursor-pointer"
//                             >
//                                 {isPlacingOrder ? "Placing Order..." : `Place Order ₹${finalToPay.toFixed(2)} 🛍️`}
//                             </button>
